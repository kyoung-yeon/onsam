  ...
  <section class="signin">
    <div class="signin__card">
      <h2>On-SAM 로그인</h2>
        ...
        $sql = "insert into user (id, pwd, name, tel, email)";             
        $sql = $sql. "values('$id','$pwd','$name','$tel', '$email')";       
        if($mysqli->query($sql)){    
                                                                                                                               //success inserting 으로 표시
        ...
        ?>
        <input type="button" value="로그인하러가기" onclick="location='signin.html'">
    </div>
  </section>
